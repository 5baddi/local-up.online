...
@section('content')
    <div class="page-header d-print-none mb-4">
        <div class="row align-items-center">
            <div class="col">
                ...
                <div class="text-muted mt-1">{{ sizeof($media['mediaItems'] ?? []) }} {{ Str::lower(trans('dashboard.photos')) ?? 'photos' }}</div>
            </div>
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('dashboard.scheduled.media') }}" class="btn btn-default">
    ...
    @if(sizeof(($media['mediaItems'] ?? [])) > 0)
        <div class="row row-cards" id="media-container">
